...
const SceneEntranceInside: React.FC<SceneNavProps> = ({ children,onSceneChange, onBack }) => {
  ...
  return (
    <Entity>
      ...
      <NavigationButton onBack={onBack} setPosition="0 0.5 -1" setRotation="-90 0 -120" />

      <NavigationButton onBack={handleNavigation} setPosition="0 1 -2" setRotation="-90 0 90" />

      <NavigationButton onBack={handleNavigation1} setPosition="0.5 1 -1.2" setRotation="-90 0 -60" />
